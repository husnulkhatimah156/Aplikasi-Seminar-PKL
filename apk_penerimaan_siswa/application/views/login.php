...
<head>
    ...
    <title>APLIKASI PENERIMAAN PESERTA DIDIK BARU PADA SMK NEGERI 1 MARABAHAN BERBASIS WEB</title>
    <link rel="apple-touch-icon" href="<?php echo base_url();?>/assets/logosmk.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url();?>/assets/logosmk.png">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo base_url();?>/assets/bg.png" width="400px" alt="branding logo">
                                </div>
                                    ...
                                    <div class="card rounded-0 mb-0 px-2" style="background-color: #c2c9f3!important;">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <center>
                                                    <img src="<?php echo base_url();?>assets/logosmk.png" width="120px;">
                                                </center>
                                                <br>
                                                <h4 class="mb-0" style="text-align: center;">APLIKASI PENERIMAAN PESERTA DIDIK BARU PADA SMK NEGERI 1 MARABAHAN BERBASIS WEB</h4>
                                            </div>
                                        </div>
