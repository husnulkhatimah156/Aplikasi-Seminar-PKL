...
<head>
	...
	<title>PERANCANGAN SISTEM INFORMASI PENERIMAAN SISWA BARU BERBASIS WEB PADA SEKOLAH DASAR SUNGAI MIAI 5 BANJARMASIN</title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="icon" href="<?php echo base_url();?>/assets/logosmk.png" type="image/x-icon"/>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="#" class="logo">
					<img style="margin-left: 60px;" src="<?php echo base_url();?>/assets/logosmk.png" width="60px" alt="navbar brand" class="navbar-brand">
				</a>
