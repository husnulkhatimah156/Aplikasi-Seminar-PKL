				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">LAPORAN DATA SISWA PINDAHAN</h2>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="tab-content px-1 pt-1">
              <div class="tab-pane active" id="tab11" role="tabpanel" aria-labelledby="base-tab11">      <br>
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-3 text-right">
                             <form target="_blank" action="<?php echo site_url('siswa/filter3') ?>" method="post">
              ...
              <div class="tab-pane" id="tab12" role="tabpanel" aria-labelledby="base-tab12">
                 <br>
                    <br>
                <div class="row">
                            <form target="_blank" action="<?php echo site_url('siswa/pindahan') ?>" method="post">
